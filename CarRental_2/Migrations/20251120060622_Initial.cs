        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentalCostPerDay = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualEndDateTime = table.Column<DateOnly>(type: "date", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RentalHistory_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarId = table.Column<int>(type: "int", nullable: false),
                    StartDateTime = table.Column<DateOnly>(type: "date", nullable: false),
                    PlannedEndDateTime = table.Column<DateOnly>(type: "date", nullable: false),
                    ActualEndDateTime = table.Column<DateOnly>(type: "date", nullable: true),
                    TotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentalHistory_ClientId",
                table: "RentalHistory",
                column: "ClientId");
        }
